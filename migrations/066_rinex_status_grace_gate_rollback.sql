-- Rollback 066: restore the ungated early-morning grace period
--
-- Reverts rinex_24h_status to the 049 expression, in which any station reads
-- 0 (OK) between 00:00 and 02:00 regardless of how stale its RINEX is.
-- Only roll back if 066 causes an unexpected regression -- the pre-066
-- behaviour hides genuinely stale stations for two hours every night.
...
DELETE FROM schema_migrations WHERE migration_name = '066_rinex_status_grace_gate';
